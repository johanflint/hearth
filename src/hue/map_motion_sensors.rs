...
pub fn map_motion_sensors(sensors: Vec<MotionGet>, device_map: &mut HashMap<String, DeviceGet>) -> Result<Vec<Device>, MapMotionSensorsError> {
    sensors
        ...
        .map(|sensor| {
            ...
            let mut properties: HashMap<String, Box<dyn Property>> = HashMap::with_capacity(3);
            ...
            let motion_property = Box::new(BooleanProperty::new("motion".to_string(), PropertyType::Motion, true, None, sensor.motion.motion_report.is_some_and(|r| r.motion)));
